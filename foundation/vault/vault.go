...
// PublicKey searches the key store for a given kid and
...
// retrieveKID performs the HTTP call against the Vault service for
// the specified kid and returns the PEM value
...
// toPublicPEM was taken from the JWT package to reduce the dependency.
// It accepts a PEM encoding of a RSA private key and converts to a PEM
// encoded public key.
